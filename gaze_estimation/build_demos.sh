...
cd $build_dir
# ####### CUSTOM
cmake -DCMAKE_BUILD_TYPE=Release -DCMAKE_CXX_FLAGS="-march=armv7-a" -DBUILD_SHARED_LIBS=ON $DEMOS_PATH
make $NUM_THREADS

printf "\nBuild completed, you can find binaries for all demos in the $build_dir/${OS_PATH}/Release subfolder.\n\n"
# cp $build_dir/${OS_PATH}/Release/gaze_estimation_demo ./gaze_estimation_demo_out
